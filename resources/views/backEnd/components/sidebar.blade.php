<div class="pe-3 mt-2" id="sidebar-wrapper">
    <div class="list-group list-group-flush mt-2">
        <a class=" sidebar-text p-3  py-2 mb-2 {{ (request()->is('dashboard') ? 'activeSidebar' : '') }}" href={{
            url('dashboard') }}><i class="fa-regular fa-folder-closed me-3"></i>Dashboard <span
                class="badge bg-danger text-notif">{{ $countExam }}</span></a>
        ...
        <a class=" sidebar-text p-3  py-2 mb-2 {{ (request()->is('user-exam*') ? 'activeSidebar' : '' ) }} " href={{
            url('user-exam') }}><i class="fa-regular fa-lemon me-3"></i>User Exam <span
                class="badge bg-danger text-notif">{{ $countApply }}</span></a>
